...
@param: null
*/
int TowerDefenseRicochetMediumLevel::getm_nbRicochet() const{
    return m_nbRicochet;
}
...
@param: null
*/
int TowerDefenseRicochetMediumLevel::getm_attackDamage() const{
...
/*
@description:
Renvoie un string avec le nom de la classe actuelle (à savoir ici: "TowerDefenseRicochetMediumLevel")

@param: null
*/
string TowerDefenseRicochetMediumLevel::getClass() const {
    return "TowerDefenseRicochetMediumLevel";
}
...
/*
@description:
La methode drawTir de la classe TowerDefenseRicochetMediumLevel permet de dessiner les tirs des tourelles rouges de maniere graphique.

@param: null
*/
void TowerDefenseRicochetMediumLevel::drawTir() const{
...
/*
@description:
La methode drawTirRicochet de la classe TowerDefenseRicochetMediumLevel permet de dessiner les ricochets des tirs des tourelles rouges de maniere graphique.

@param: null
*/
void TowerDefenseRicochetMediumLevel::drawTirRicochet(vector <Monstre *> *MonstreList) const{
...
/*
@description:
La methode attaque de la classe TowerDefenseRicochetMediumLevel prend un pointeur de Monstre en parametre et fait baisser la vie du monstre pointe par le pointeur.
...
*/
void TowerDefenseRicochetMediumLevel::attaque(Monstre* monstreEnnemi){
...
-param1: un pointeur pointant sur le Monstre que la tourelle attaque
*/
void TowerDefenseRicochetMediumLevel::attaquer(Monstre* monstreEnnemi, int const& g){
monstreEnnemi->receiveDamage(m_attackDamage/LibMatrix::puissance(2,g));//Le monstre recoit des dommages
}

/*
@description:
La methode watchdog de la classe TowerDefenseRicochetMediumLevel etablie la procedure d'attaque des tourelles.
...
*/
void TowerDefenseRicochetMediumLevel::watchdog(vector <Monstre *> *MonstreList){
    float distanceTowerMonstre=10.0;
    float currentDistanceTowerMonstre=0.0;
    int index=0;
