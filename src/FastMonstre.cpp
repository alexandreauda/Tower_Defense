...
*/
void FastMonstre::draw(Joueur* player) const{
...
/*
@description:
La methode walk de la classe FastMonstre permet au FastMonstre de trouver son chemin dans le labyrinthe et de se deplacer en consequence, du block ou se trouve le FastMonstre initialement au prochain block, le tout de maniere continue.
...
*/
void FastMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
FastMonstre& FastMonstre::operator=(FastMonstre const& monstreAcopier){
