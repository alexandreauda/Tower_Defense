...
/*
@description:
La methode draw de la classe BlockSaveGame permet de dessiner  de maniere graphique le bouton qui lancera les vagues de monstres.
...
void BlockSaveGame::draw() const
{
    ...
    char* textSaveGame=new char[20]{'S','A','V','E'};//Contient le texte SAVE.
