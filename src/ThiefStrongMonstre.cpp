...
/*
@description:
La methode getClass de la classe ThiefStrongMonstre renvoie le nom de la Class (ici, le string "ThiefStrongMonstre").

@param: null
*/
string ThiefStrongMonstre::getClass() const{
    return "ThiefStrongMonstre";
}

/*
@description:
La methode draw de la classe ThiefStrongMonstre permet de dessiner des Monstres jaune-vert pale de maniere graphique.
...
*/
void ThiefStrongMonstre::draw(Joueur* player) const{

    //Met les valeurs RGB dans la couleur jaune-vert pale
    float r=1.0;
    float g=0.8;
    float b=0.4;
...
/*
@description:
La methode walk de la Class ThiefStrongMonstre permet au ThiefStrongMonstre de trouver son chemin dans le labyrinthe et de se deplacer en consequence, du block ou se trouve le FastMonstre initialement au prochain block, le tout de maniere continue.
...
*/
void ThiefStrongMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
/*
@description:
La methode increaseMoneyStolen de la Class ThiefStrongMonstre prend un int en parametre et fait augmenter la valeur de l'argent derobe par le ThiefStrongMonstre d'une valeur egale a la valeur du int pris en parametre.

@param: La methode increaseMoneyStolen prend un parametre facultatif: un int facultatif.
-param1: Le int facultatif doit representer la valeur de l'augmentation de l'argent derobe par le ThiefStrongMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefStrongMonstre::increaseMoneyStolen(int const& rateMoneyStolen){
...
/*
@description:
La methode increaseLevelMonstre de la Class ThiefStrongMonstre permet de gerer le niveau des Monstres en fonction du niveau du level. Ainsi, un Joueur de niveau 1 par exemple, combattra des Monsres de niveau 1 et ainsi de suite.
...
-param1: Le string facultatif doit representer le nom de l'attribut du ThiefStrongMonstre que l'on veut augmenter. Par defaut, ce parametre vaut "random" ce qui signifie que l'augmentation de niveau augmente un des attributs du Monstre determine aleatoirement.
-param3: Le int unsigned facultatif doit representer la valeur du facteur de l'augmentation d'un attribut du ThiefStrongMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefStrongMonstre::increaseLevelMonstre(Joueur* player, string const& nameAttribut, int unsigned const& stepIncrease){
...
ThiefStrongMonstre& ThiefStrongMonstre::operator=(ThiefStrongMonstre const& monstreAcopier){
