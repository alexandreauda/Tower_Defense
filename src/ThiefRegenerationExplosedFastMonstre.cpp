#include "ThiefRegenerationExplosedFastMonstre.h"
...
/*
@description:
La methode getClass de la classe ThiefRegenerationExplosedFastMonstre renvoie le nom de la Class (ici, le string "ThiefRegenerationExplosedFastMonstre").

@param: null
*/
string ThiefRegenerationExplosedFastMonstre::getClass() const{
    return "ThiefRegenerationExplosedFastMonstre";
}

/*
@description:
La methode draw de la classe ThiefRegenerationExplosedFastMonstre permet de dessiner des Monstres jaune tres pale de maniere graphique.
...
*/
void ThiefRegenerationExplosedFastMonstre::draw(Joueur* player) const{

    //Met les valeurs RGB dans la couleur jaune tres pale
    float r=1.0;
    float g=1.0;
    float b=0.3;
...
/*
@description:
La methode walk de la classe ThiefRegenerationExplosedFastMonstre permet au ThiefRegenerationExplosedFastMonstre de trouver son chemin dans le labyrinthe et de se deplacer en consequence, du block ou se trouve le FastMonstre initialement au prochain block, le tout de maniere continue.
...
*/
void ThiefRegenerationExplosedFastMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
/*
@description:
La methode increaseMoneyStolen de la Class ThiefRegenerationExplosedFastMonstre prend un int en parametre et fait augmenter la valeur de l'argent derobe par le ThiefRegenerationExplosedFastMonstre d'une valeur egale a la valeur du int pris en parametre.

@param: La methode increaseMoneyStolen prend un parametre facultatif: un int facultatif.
-param1: Le int facultatif doit representer la valeur de l'augmentation de l'argent derobe par le ThiefRegenerationExplosedFastMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefRegenerationExplosedFastMonstre::increaseMoneyStolen(int const& rateMoneyStolen){
...
/*
@description:
La methode increaseLevelMonstre de la Class ThiefRegenerationExplosedFastMonstre permet de gerer le niveau des Monstres en fonction du niveau du level. Ainsi, un Joueur de niveau 1 par exemple, combattra des Monsres de niveau 1 et ainsi de suite.
...
-param1: Le string facultatif doit representer le nom de l'attribut du ThiefRegenerationExplosedFastMonstre que l'on veut augmenter. Par defaut, ce parametre vaut "random" ce qui signifie que l'augmentation de niveau augmente un des attributs du Monstre determine aleatoirement.
-param3: Le int unsigned facultatif doit representer la valeur du facteur de l'augmentation d'un attribut du ThiefRegenerationExplosedFastMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefRegenerationExplosedFastMonstre::increaseLevelMonstre(Joueur* player, string const& nameAttribut, int unsigned const& stepIncrease){
...
/*
@description:
La methode regeneration de la classe ThiefRegenerationExplosedFastMonstre permet de regenerer la vie du Monstre d'une valeur egale a celle de l'attribut m_rateRegeneration.

@param: null
*/
void ThiefRegenerationExplosedFastMonstre::regeneration(){
    int const vieAfterRegeneration=m_vie+m_rateRegeneration;
    int const vieMax=LibMatrix::loadIntInFileWithDirectory("InitialLifeThiefRegenerationExplosedFastMonstre","InitialLifeMonstre/");
...
ThiefRegenerationExplosedFastMonstre& ThiefRegenerationExplosedFastMonstre::operator=(ThiefRegenerationExplosedFastMonstre const& monstreAcopier){
