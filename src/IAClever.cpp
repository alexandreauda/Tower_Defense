...
BlockGrille IAClever::searchInitWay(BlockGrille grilleDeJeu[12][12]) const{
 ...
 BlockGrille IAClever::searchWay(BlockGrille grilleDeJeu[12][12]){
    //TODO
    //return
 }
 ...
 /*
@description:
La methode searchIfWay de la classe IAClever renvoie 1 s'il existe un block sur lequel un monstre peut se rendre sur la grille pour continuer a avancer et 0 si le Monstre ne trouve aucun block sur lequel il peut avancer.

@param: La methode searchIfWay de la classe IAClever prend un parametre obligatoire: une matrice de BlockGrille de dimension 12*12 dans lequel l'IA effectura sa recherche.
-param1: une matrice de BlockGrille de dimension 12*12 dans lequel l'IA effectura sa recherche.
*/
int IAClever::searchIfWay(BlockGrille grilleDeJeu[12][12]) const{
...
/*
@description:
Renvoie un string avec le nom de la classe actuelle (à savoir ici: "IAClever")

@param: null
*/
string IAClever::getClass() const {
    return "IAClever";
}
