...
/*
@description:
La methode getClass de la classe ThiefFastMonstre renvoie le nom de la Class (ici, le string "ThiefFastMonstre").

@param: null
*/
string ThiefFastMonstre::getClass() const{
    return "ThiefFastMonstre";
}

/*
@description:
La methode draw de la classe ThiefFastMonstre permet de dessiner des Monstres bleus pale de maniere graphique.
...
*/
void ThiefFastMonstre::draw(Joueur* player) const{

    //Met les valeurs RGB dans la couleur bleue pale
    float r=0.1;
    float g=0.5;
    float b=0.6;
...
/*
@description:
La methode walk de la classe ThiefFastMonstre permet au ThiefFastMonstre de trouver son chemin dans le labyrinthe et de se deplacer en consequence, du block ou se trouve le FastMonstre initialement au prochain block, le tout de maniere continue.
...
*/
void ThiefFastMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
/*
@description:
La methode increaseMoneyStolen de la Class ThiefFastMonstre prend un int en parametre et fait augmenter la valeur de l'argent derobe par le ThiefFastMonstre d'une valeur egale a la valeur du int pris en parametre.

@param: La methode increaseMoneyStolen prend un parametre facultatif: un int facultatif.
-param1: Le int facultatif doit representer la valeur de l'augmentation de l'argent derobe par le ThiefFastMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefFastMonstre::increaseMoneyStolen(int const& rateMoneyStolen){
...
/*
@description:
La methode increaseLevelMonstre de la Class ThiefFastMonstre permet de gerer le niveau des Monstres en fonction du niveau du level. Ainsi, un Joueur de niveau 1 par exemple, combattra des Monsres de niveau 1 et ainsi de suite.
...
-param1: Le string facultatif doit representer le nom de l'attribut du ThiefFastMonstre que l'on veut augmenter. Par defaut, ce parametre vaut "random" ce qui signifie que l'augmentation de niveau augmente un des attributs du Monstre determine aleatoirement.
-param3: Le int unsigned facultatif doit representer la valeur du facteur de l'augmentation d'un attribut du ThiefFastMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefFastMonstre::increaseLevelMonstre(Joueur* player, string const& nameAttribut, int unsigned const& stepIncrease){
...
ThiefFastMonstre& ThiefFastMonstre::operator=(ThiefFastMonstre const& monstreAcopier){
