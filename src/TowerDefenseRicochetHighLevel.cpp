...
@param: null
*/
int TowerDefenseRicochetHighLevel::getm_nbRicochet() const{
    return m_nbRicochet;
}
...
@param: null
*/
int TowerDefenseRicochetHighLevel::getm_attackDamage() const{
...
/*
@description:
Renvoie un string avec le nom de la classe actuelle (à savoir ici: "TowerDefenseRicochetHighLevel")

@param: null
*/
string TowerDefenseRicochetHighLevel::getClass() const {
    return "TowerDefenseRicochetHighLevel";
}

/*
@description:
La methode draw de la classe TowerDefenseRicochetHighLevel permet de dessiner des tourelles rouges tres fonce de maniere graphique dans le m_blockBase.

@param: null
*/
void TowerDefenseRicochetHighLevel::draw() const{

    //Met les valeurs RGB dans la couleur rouge tres fonce
    float const r=0.4;
    float const g=0.0;
    float const b=0.0;
...
/*
@description:
La methode drawTir de la classe TowerDefenseRicochetHighLevel permet de dessiner les tirs des tourelles rouges de maniere graphique.

@param: null
*/
void TowerDefenseRicochetHighLevel::drawTir() const{
...
/*
@description:
La methode drawTirRicochet de la classe TowerDefenseRicochetHighLevel permet de dessiner les ricochets des tirs des tourelles rouges de maniere graphique.

@param: null
*/
void TowerDefenseRicochetHighLevel::drawTirRicochet(vector <Monstre *> *MonstreList) const{
...
/*
@description:
La methode attaque de la classe TowerDefenseRicochetHighLevel prend un pointeur de Monstre en parametre et fait baisser la vie du monstre pointe par le pointeur.
...
*/
void TowerDefenseRicochetHighLevel::attaque(Monstre* monstreEnnemi){
...
-param1: un pointeur pointant sur le Monstre que la tourelle attaque
*/
void TowerDefenseRicochetHighLevel::attaquer(Monstre* monstreEnnemi, int const& g){
monstreEnnemi->receiveDamage(m_attackDamage/LibMatrix::puissance(2,g));//Le monstre recoit des dommages
}

/*
@description:
La methode watchdog de la classe TowerDefenseRicochetHighLevel etablie la procedure d'attaque des tourelles.
...
*/
void TowerDefenseRicochetHighLevel::watchdog(vector <Monstre *> *MonstreList){
    float distanceTowerMonstre=10.0;
    float currentDistanceTowerMonstre=0.0;
    int index=0;
