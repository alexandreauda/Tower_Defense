...
/*
@description:
La methode getClass de la classe ThiefExplosedFastMonstre renvoie le nom de la Class (ici, le string "ThiefExplosedFastMonstre").

@param: null
*/
string ThiefExplosedFastMonstre::getClass() const{
    return "ThiefExplosedFastMonstre";
}

/*
@description:
La methode draw de la classe ThiefExplosedFastMonstre permet de dessiner des Monstres verts tres pale de maniere graphique.
...
*/
void ThiefExplosedFastMonstre::draw(Joueur* player) const{

    //Met les valeurs RGB dans la couleur vert tres pale
    float r=0.6;
    float g=0.8;
    float b=0.5;
...
/*
@description:
La methode walk de la classe ThiefExplosedFastMonstre permet au ThiefExplosedFastMonstre de trouver son chemin dans le labyrinthe et de se deplacer en consequence, du block ou se trouve le FastMonstre initialement au prochain block, le tout de maniere continue.
...
*/
void ThiefExplosedFastMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
/*
@description:
La methode increaseMoneyStolen de la Class ThiefExplosedFastMonstre prend un int en parametre et fait augmenter la valeur de l'argent derobe par le ThiefExplosedFastMonstre d'une valeur egale a la valeur du int pris en parametre.

@param: La methode increaseMoneyStolen prend un parametre facultatif: un int facultatif.
-param1: Le int facultatif doit representer la valeur de l'augmentation de l'argent derobe par le ThiefExplosedFastMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefExplosedFastMonstre::increaseMoneyStolen(int const& rateMoneyStolen){
...
/*
@description:
La methode increaseLevelMonstre de la Class ThiefExplosedFastMonstre permet de gerer le niveau des Monstres en fonction du niveau du level. Ainsi, un Joueur de niveau 1 par exemple, combattra des Monsres de niveau 1 et ainsi de suite.
...
-param1: Le string facultatif doit representer le nom de l'attribut du ThiefExplosedFastMonstre que l'on veut augmenter. Par defaut, ce parametre vaut "random" ce qui signifie que l'augmentation de niveau augmente un des attributs du Monstre determine aleatoirement.
-param3: Le int unsigned facultatif doit representer la valeur du facteur de l'augmentation d'un attribut du ThiefExplosedFastMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefExplosedFastMonstre::increaseLevelMonstre(Joueur* player, string const& nameAttribut, int unsigned const& stepIncrease){
...
ThiefExplosedFastMonstre& ThiefExplosedFastMonstre::operator=(ThiefExplosedFastMonstre const& monstreAcopier){
