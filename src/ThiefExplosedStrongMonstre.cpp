...
/*
@description:
La methode getClass de la classe ThiefExplosedStrongMonstre renvoie le nom de la Class (ici, le string "ThiefExplosedStrongMonstre").

@param: null
*/
string ThiefExplosedStrongMonstre::getClass() const{
    return "ThiefExplosedStrongMonstre";
}

/*
@description:
La methode draw de la classe ThiefExplosedStrongMonstre permet de dessiner des Monstres violets tres pale de maniere graphique.
...
*/
void ThiefExplosedStrongMonstre::draw(Joueur* player) const{

    //Met les valeurs RGB dans la couleur violet tres pale
    float r=0.7;
    float g=0.4;
    float b=0.8;
...
/*
@description:
La methode walk de la classe ThiefExplosedStrongMonstre permet au ThiefExplosedStrongMonstre de trouver son chemin dans le labyrinthe et de se deplacer en consequence, du block ou se trouve le FastMonstre initialement au prochain block, le tout de maniere continue.
...
*/
void ThiefExplosedStrongMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
/*
@description:
La methode increaseMoneyStolen de la Class ThiefExplosedStrongMonstre prend un int en parametre et fait augmenter la valeur de l'argent derobe par le ThiefExplosedStrongMonstre d'une valeur egale a la valeur du int pris en parametre.

@param: La methode increaseMoneyStolen prend un parametre facultatif: un int facultatif.
-param1: Le int facultatif doit representer la valeur de l'augmentation de l'argent derobe par le ThiefExplosedStrongMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefExplosedStrongMonstre::increaseMoneyStolen(int const& rateMoneyStolen){
...
/*
@description:
La methode increaseLevelMonstre de la Class ThiefExplosedStrongMonstre permet de gerer le niveau des Monstres en fonction du niveau du level. Ainsi, un Joueur de niveau 1 par exemple, combattra des Monsres de niveau 1 et ainsi de suite.
...
-param1: Le string facultatif doit representer le nom de l'attribut du ThiefExplosedStrongMonstre que l'on veut augmenter. Par defaut, ce parametre vaut "random" ce qui signifie que l'augmentation de niveau augmente un des attributs du Monstre determine aleatoirement.
-param3: Le int unsigned facultatif doit representer la valeur du facteur de l'augmentation d'un attribut du ThiefExplosedStrongMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefExplosedStrongMonstre::increaseLevelMonstre(Joueur* player, string const& nameAttribut, int unsigned const& stepIncrease){
...
ThiefExplosedStrongMonstre& ThiefExplosedStrongMonstre::operator=(ThiefExplosedStrongMonstre const& monstreAcopier){
