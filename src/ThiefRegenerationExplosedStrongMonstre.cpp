...
*/
void ThiefRegenerationExplosedStrongMonstre::walk(Joueur* player, string const& stringNameDirectory){
...
/*
@description:
La methode increaseRateRegeneration de la classe ThiefRegenerationExplosedStrongMonstre prend un int en parametre et fait augmenter l'attribut m_rateRegeneration du RegenerationExplosedStrongMonstre d'une valeur egale a la valeur du int pris en parametre.

@param: La methode increaseRateRegeneration prend un parametre facultatif: un int facultatif.
-param1: Le int facultatif doit representer la valeur de l'augmentation de l'attribut m_rateRegeneration du ThiefRegenerationExplosedStrongMonstre. Par defaut, ce parametre vaut 1.
*/
void ThiefRegenerationExplosedStrongMonstre::increaseRateRegeneration(int const& rateRegenerationWin){
